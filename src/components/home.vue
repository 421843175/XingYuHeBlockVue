  ...
  <div>
    ...
    <transition name="el-fade-in-linear">
      ...
      <div v-show="toolbar.visible"
           ...
           :class="[{ enter: toolbar.enter }, { hoverEnter: (hoverEnter || this.$route.path === '/coderecord' || this.$route.path === '/share') && !toolbar.enter }]"
        ...
        <div v-else>
          <ul class="scroll-menu">
            ...
            <li @click="$router.push({path: '/timechange'})">
              <div class="my-menu">
                🚀 <span>四维空间</span>
              </div>
            </li>
            ...
            <li @click="$router.push({path: '/share'})">
                      <div class="my-menu">
                        🍬 <span>我的分享</span>
                      </div>
             </li>
            ...
            <li @click="$router.push({path: '/coderecord'})">
              <div class="my-menu">
                🖊 <span>CODE飞翼</span>
              </div>
            </li>
    ...
    <el-drawer :visible.sync="toolbarDrawer"
      ...
      <div>
        <ul class="small-menu">
          ...
          <li @click="smallMenu({path: '/timechange'})">
            <div>
            🚀 <span>四维空间</span>
            </div>
          </li>

       <li @click="smallMenu({path: '/share'})">
            <div>
            🍬 <span>我的分享</span>
            </div>
          </li>
          ...
          <!-- 百宝箱 -->
          <li @click="smallMenu({path: '/coderecord'})">
            <div>
              🖊 <span>CODE飞翼</span>
            </div>
          </li>
  ...
  export default {
    ...
    mounted() {
      ...
      if (this.isDaylight()) {
        ...
        root.style.setProperty("--coderecordBg", "#1e1e1e");
      }
    },
    destroyed() {
    ...
    methods: {
      ...
      //         this.$store.commit("loadWebInfo", res.data.data);
      //         localStorage.setItem("defaultStoreType", res.data.data.defaultStoreType);
      //       }
      //     })
      //     .catch((error) => {
      //       this.$message({
      ...
      changeColor() {
        ...
        if (this.isDark) {
          ...
          root.style.setProperty("--coderecordBg", "#f7f9fe");
        }
      },
      toTop() {
        window.scrollTo({
